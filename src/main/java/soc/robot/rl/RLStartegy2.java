...
// * [done] potentials also updated! TO DO: tracker copies the original player (aka info on number of potential settlements
...
//    				state_values.add(Float.valueOf(currentStateValue.floatValue()));
//					robPositions.add(Integer.valueOf(posRob));
//					playersToRob.add(Integer.valueOf(-1));
//    			} else {
//    				
